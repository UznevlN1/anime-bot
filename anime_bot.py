...
def premium_menu_keyboard(prices):
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=f"1 oy — {fmt_som(prices['1m'])}", callback_data="premium_buy_1m", style="success")],
        [InlineKeyboardButton(text=f"3 oy — {fmt_som(prices['3m'])}", callback_data="premium_buy_3m", style="success")],
        [InlineKeyboardButton(text=f"1 yil — {fmt_som(prices['1y'])}", callback_data="premium_buy_1y", style="success")],
...
async def premium_menu(call: CallbackQuery):
    ...
    try:
        await call.message.edit_text(text, reply_markup=premium_menu_keyboard(prices), parse_mode="HTML")
    except Exception:
        await call.message.answer(text, reply_markup=premium_menu_keyboard(prices), parse_mode="HTML")
