...
WEBAPP_URL = "https://anime-bot-fd8r.onrender.com/webapp"
...
def main_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="🎌 Animelarni ko'rish", web_app=WebAppInfo(url=WEBAPP_URL))],
...
async def start_web_server():
    import os
    # Render'da fayl joylashuvi: bot fayli bilan bir papkada webapp/ bo'lishi kerak
    ...
    app.router.add_get("/webapp", lambda r: web.FileResponse(webapp_index))
